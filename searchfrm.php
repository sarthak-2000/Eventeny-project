                      ...
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="index.php">
                            ...
                            <div class="form-group">
                              <input class="form-control"  name="e_name" value="<?php echo $i; ?>">
                            </div>
                            <div class="form-group">
                              <input class="form-control"  name="e_date" value="<?php echo $a; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control"  name="e_time" value="<?php echo $b; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control"  name="address" value="<?php echo $c; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control"  name="price" value="<?php echo $d; ?>">
                            </div> 
                            <div class="form-group">
                             <label>Comment</label>
